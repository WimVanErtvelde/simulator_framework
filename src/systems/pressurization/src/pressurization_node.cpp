...
class PressurizationNode : public rclcpp_lifecycle::LifecycleNode
{
public:
  PressurizationNode()
  : LifecycleNode("sim_pressurization", rclcpp::NodeOptions().parameter_overrides(
      {{"use_sim_time", true}}))
  {
    ...
    RCLCPP_INFO(this->get_logger(), "sim_pressurization constructed (unconfigured)");
  }
  ...
  CallbackReturn on_activate(const rclcpp_lifecycle::State &) override
  {
    ...
    RCLCPP_INFO(this->get_logger(), "sim_pressurization activated");
  ...
  CallbackReturn on_deactivate(const rclcpp_lifecycle::State &) override
  {
    ...
    RCLCPP_INFO(this->get_logger(), "sim_pressurization deactivated");
    publish_lifecycle_state("inactive");
    return CallbackReturn::SUCCESS;
  }
  ...
  CallbackReturn on_cleanup(const rclcpp_lifecycle::State &) override
  {
    ...
    RCLCPP_INFO(this->get_logger(), "sim_pressurization cleaned up");
...
int main(int argc, char ** argv)
{
  ...
  auto node = std::make_shared<PressurizationNode>();
