...
class HydraulicNode : public rclcpp_lifecycle::LifecycleNode
{
public:
  HydraulicNode()
  : LifecycleNode("sim_hydraulic", rclcpp::NodeOptions().parameter_overrides(
      {{"use_sim_time", true}}))
  {
    ...
    RCLCPP_INFO(this->get_logger(), "sim_hydraulic constructed (unconfigured)");
  }
  ...
  CallbackReturn on_configure(const rclcpp_lifecycle::State &) override
  {
    ...
    RCLCPP_INFO(this->get_logger(), "sim_hydraulic configured");
  ...
  CallbackReturn on_activate(const rclcpp_lifecycle::State &) override
  {
    ...
    RCLCPP_INFO(this->get_logger(), "sim_hydraulic activated");
  ...
  CallbackReturn on_deactivate(const rclcpp_lifecycle::State &) override
  {
    ...
    RCLCPP_INFO(this->get_logger(), "sim_hydraulic deactivated");
    publish_lifecycle_state("inactive");
    return CallbackReturn::SUCCESS;
  }
  ...
  CallbackReturn on_cleanup(const rclcpp_lifecycle::State &) override
  {
    ...
    RCLCPP_INFO(this->get_logger(), "sim_hydraulic cleaned up");
...
int main(int argc, char ** argv)
{
  ...
  auto node = std::make_shared<HydraulicNode>();
