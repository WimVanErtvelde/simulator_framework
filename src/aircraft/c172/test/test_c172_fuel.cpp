// C172-specific fuel topology tests.
// Loads the C172 fuel v2 YAML and verifies selector behaviour, pump failures,
// gravity feed, fuel exhaustion, leaks, jams, CAS messages, and reset.
