...
class MicroRosBridgeNode : public rclcpp_lifecycle::LifecycleNode
{
public:
  MicroRosBridgeNode()
  : LifecycleNode("microros_bridge", rclcpp::NodeOptions().parameter_overrides(
      {{"use_sim_time", true}}))
  {
    ...
    RCLCPP_INFO(this->get_logger(), "microros_bridge constructed (unconfigured)");
  }
  ...
  CallbackReturn on_configure(const rclcpp_lifecycle::State &) override
  {
    ...
    RCLCPP_INFO(this->get_logger(), "microros_bridge configured");
  ...
  CallbackReturn on_activate(const rclcpp_lifecycle::State &) override
  {
    ...
    RCLCPP_INFO(this->get_logger(), "microros_bridge activated");
  ...
  CallbackReturn on_deactivate(const rclcpp_lifecycle::State &) override
  {
    ...
    RCLCPP_INFO(this->get_logger(), "microros_bridge deactivated");
    publish_lifecycle_state("inactive");
    return CallbackReturn::SUCCESS;
  }
  ...
  CallbackReturn on_cleanup(const rclcpp_lifecycle::State &) override
  {
    ...
    RCLCPP_INFO(this->get_logger(), "microros_bridge cleaned up");
...
int main(int argc, char ** argv)
{
  ...
  auto node = std::make_shared<MicroRosBridgeNode>();
